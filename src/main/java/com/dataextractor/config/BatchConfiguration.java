...
public class BatchConfiguration {
	...
	public FlatFileItemReader<Transaction> reader() {
		...
		lineMapper.setLineTokenizer(new SingleLineTokenizer());
	...
	public JdbcBatchItemWriter<Transaction> writer(DataSource dataSource) {
		return new JdbcBatchItemWriterBuilder<Transaction>()
				...
				.sql("INSERT INTO transaction (transactionId, transactionDate,transactionType,transactionAmt,authorizationNmbr) VALUES (:transactionId,:transactionDate,:transactionType,:transactionAmt,:authorizationNmbr)").dataSource(dataSource)
				.build();
	}
